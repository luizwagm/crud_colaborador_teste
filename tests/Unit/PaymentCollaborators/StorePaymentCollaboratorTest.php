...
class StorePaymentCollaboratorTest extends TestCase
{
    use WithFaker;
     ...
     * @return void
     */
    public function createNewPaymentCollaboratorOrUpdateAnExisting()
    {
        $params = [
            'salary' => strval(rand(1000.00, 10000.00))
        ];

        $response = $this->service->store($params, $this->collaborator->original['data']->id);
